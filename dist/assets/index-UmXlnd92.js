(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();class x{constructor(){this.listeners={}}on(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)}emit(e,t){this.listeners[e]&&this.listeners[e].forEach(s=>s(t))}}class d extends x{constructor(e,t,s,i=400,n=300,o=null){super(),this.id=e,this.title=t,this.content=s,o?(this.width=o.width,this.height=o.height,this.x=o.x,this.y=o.y,this.isMinimized=o.isMinimized,this.zIndex=o.zIndex):(this.width=i,this.height=n,this.x=Math.min(Math.max(0,Math.random()*(window.innerWidth-i-100)),window.innerWidth-i-100),this.y=Math.min(Math.max(50,Math.random()*(window.innerHeight-n-100)),window.innerHeight-n),this.isMinimized=!1),this.isDragging=!1,this.initialX=0,this.initialY=0,this.initialMouseX=0,this.initialMouseY=0,this.createElement(),this.x=Math.min(Math.max(0,this.x),Math.max(0,window.innerWidth-i)),this.y=Math.min(Math.max(0,this.y),Math.max(0,window.innerHeight-n)),this.isMinimized&&this.minimize(),window.addEventListener("resize",this.handleResize.bind(this))}createElement(){this.element=document.createElement("div"),this.element.className="window",this.element.style.cssText=`
        position: fixed;
        left: ${this.x}px;
        top: ${this.y}px;
        width: ${this.width}px;
      ...
      `,this.titleBar=document.createElement("div"),this.titleBar.className="window-title-bar",this.titleBar.style.cssText=`
        ...
        align-items: center;
        height: 40px;
      `;const e=document.createElement("div");e.className="window-title-bar-text",e.textContent=this.title,this.titleBar.appendChild(e);const t=document.createElement("div");t.style.display="flex";const s=document.createElement("button");s.textContent="−",s.style.cssText=`
        border: none;
        background: none;
        font-size: 20px;
        font-weight: bolder;
        ...
        padding: 0 5px;
        margin-right: 5px;
      `,s.onclick=n=>{n.stopPropagation(),this.toggleMinimize()},t.appendChild(s);const i=document.createElement("button");i.textContent="×",i.style.cssText=`
        border: none;
        background: none;
        font-size: 20px;
        font-weight: bolder;
    ...
    `}setPosition(e,t){this.element.style.left=`${e}px`,this.element.style.top=`${t}px`}}class b{constructor(e=!1){this.windows=new Map,this.icons=new Map,this.zIndexBase=1e3,this.currentlyDragging=null,this.username="Anonymous-"+Math.floor(Math.random()*1e3);const t=document.createElement("link");t.href="https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500&display=swap",t.rel="stylesheet",document.head.appendChild(t),this.environment=document.createElement("div"),this.environment.id="window-environment",this.environment.style.cssText=`
      ...
      overflow-x: hidden;
      overflow-y: hidden;
      `,this.taskbar=document.createElement("div"),this.taskbar.id="taskbar",this.iconContainer=document.createElement("div"),this.iconContainer.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
